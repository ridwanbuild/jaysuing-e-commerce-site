...
export default function Faq() {
  ...
  return (
    <section id="faq">
      <main className="flex scroll-mt-10 items-center flex-col justify-between bg-[url('https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/hero/dot-pattern-bg.svg')] bg-cover text-sm text-gray-800 max-md:px-4 text-center h-[585px]">
        {/* Navbar */}
